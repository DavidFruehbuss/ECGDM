...
class Conditional_Diffusion_Model(nn.Module):
    ...
    def noise_process(self, z_data):
        ...
        index = torch.cat((molecule['idx'], protein_pocket['idx']))
        ...
        eps_x = x_noise - scatter_mean(x_noise, index, dim=0)[index]
        ...
        # alpha_t: [16] -> [16,13]
        # [300] * [300,13]
        alpha_t = alpha_t.view((16,1)).expand(16, 13).repeat(1, 13)
        sigma_t = sigma_t.view((16,1)).expand(16, 13).repeat(1, 13)
