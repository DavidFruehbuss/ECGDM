...
xray_directory = '/gpfs/home4/dfruhbuss/ECGDM/Data/Peptide_data/xray_rotated'
eight_k_directory = '/gpfs/home4/dfruhbuss/ECGDM/Data/Peptide_data/8k_clustered_rotated'
output_directory = '/gpfs/home4/dfruhbuss/ECGDM/Data/Peptide_data/combined_rotated'
...
for i in range(10):
    ...
    xray_file = os.path.join(xray_directory, f'cleaned_pMHCI_cluster{i}_rotated.hdf5')
    eight_k_file = os.path.join(eight_k_directory, f'BA_pMHCI_cluster{i}_rotated.hdf5')
    ...
    if os.path.exists(xray_file) and os.path.exists(eight_k_file):
        ...
        output_file = os.path.join(output_directory, f'combined_cluster{i}_rotated.hdf5')
